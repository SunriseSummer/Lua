...
int luaB_cangjie_string (lua_State *L) {
  ...
  switch (lua_type(L, 1)) {
    ...
    case LUA_TTABLE: {
      /* Table (byte array) -> String: delegate to luaB_string_from_byte_array */
      return luaB_string_from_byte_array(L);
    }
    default: {
      luaL_tolstring(L, 1, NULL);
      return 1;
...
/*
** Option type support moved to lbaselib_cj_option.c
*/
